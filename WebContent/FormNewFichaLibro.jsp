...
<form action="CreateFichaServlet" method="post">
	...
	<span class="contact100-form-title">
            ...
            <div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
                ...
                <input class="input100" type="text" name="title" placeholder="Introduzca el titulo del libro">
            </div>
<center>
            <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" >
                <span class="label-input100">Autor *</span>
                <input class="input100" type="text" name="autor" placeholder="Introduzca el autor ">
            </div>
            <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" >
                <span class="label-input100">Fecha de publicacion del libro *</span>
                <input class="input100" type="text" name="fecha" placeholder="Introduzca fecha ">
            </div>
            <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" ">
                <span class="label-input100">Editorial *</span>
                <input class="input100" type="text" name="editorial" placeholder="Introduzca la editorial del libro ">
            </div>
